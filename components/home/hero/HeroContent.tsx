...
export async function HeroContent() {
  ...
  return (
    <section className="relative flex min-h-[560px] flex-col justify-center overflow-hidden py-10 lg:min-h-[640px] lg:py-12 2xl:min-h-[700px]">
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 z-0">
        {heroFruits.map((fruit) => (
          <AssetImage
            ...
            src={fruit.src}
            wrapperClassName={`absolute z-0 ${fruit.className}`}
          />
        ))}
      </div>

      <div className="relative z-20 max-w-[980px]">
      ...
      <div className="relative z-20 mt-10 grid gap-6 xl:grid-cols-[360px_1fr] xl:items-end xl:justify-between">
        ...
        <p className="max-w-[520px] text-[1.02rem] font-medium leading-8 text-[#355654] xl:justify-self-end">
          FreshCo makes fruit, vegetables, pantry staples, and household
          essentials easy to order for every home, with clear departments and a
